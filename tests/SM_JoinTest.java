...
class JoinsDriver implements GlobalConst {
  ...
  public boolean runTests() {
    ...
    Disclaimer();
    Query1();
    System.out.println("Total reads after SM_JoinQuery2:"+PCounter.getReads());
    System.out.println("Total writes after SM_JoinQuery2:"+PCounter.getWrites());
    PCounter.initialize();
    Query2();
    System.out.println("Total reads after SM_JoinQuery1:"+PCounter.getReads());
    System.out.println("Total writes after SM_JoinQuery1:"+PCounter.getWrites());
    PCounter.initialize();

    Query3();
    System.out.println("Total reads after SM_JoinQuery3:"+PCounter.getReads());
    System.out.println("Total writes after SM_JoinQuery3:"+PCounter.getWrites());
    PCounter.initialize();
    
   
    Query4();
    System.out.println("Total reads after SM_JoinQuery4:"+PCounter.getReads());
    System.out.println("Total writes after SM_JoinQuery4:"+PCounter.getWrites());
    PCounter.initialize();

    Query5();
    System.out.println("Total reads after SM_JoinQuery5:"+PCounter.getReads());
    System.out.println("Total writes after SM_JoinQuery5:"+PCounter.getWrites());
    PCounter.initialize();

    Query6();
    System.out.println("Total reads after SM_JoinQuery6:"+PCounter.getReads());
    System.out.println("Total writes after SM_JoinQuery6:"+PCounter.getWrites());
    PCounter.initialize();
