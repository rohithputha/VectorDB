...
class IndexDriver extends TestDriver 
  ...
  protected boolean test1()
  {
    ...
    System.out.println("Total reads after Index test1:"+PCounter.getReads());
    System.out.println("Total writes after Index test1:"+PCounter.getWrites());
    PCounter.rcounter = 0;
    PCounter.wcounter = 0;
  ...
  protected boolean test2()
  {
    ...
    System.out.println("Total reads after Index test2:"+PCounter.getReads());
    System.out.println("Total writes after Index test2:"+PCounter.getWrites());
    PCounter.rcounter = 0;
    PCounter.wcounter = 0;
  ...
  { 
    ...
    System.out.println("Total reads after Index test3:"+PCounter.getReads());
    System.out.println("Total writes after Index test3:"+PCounter.getWrites());
    PCounter.rcounter = 0;
    PCounter.wcounter = 0;
