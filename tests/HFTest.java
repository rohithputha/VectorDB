...
public boolean runTests () {
  ...
  protected boolean test1 ()  {
	...
	if ( SystemDefs.JavabaseBM.getNumUnpinnedBuffers() 
	  ...
	  System.out.println("Total reads after HF test1:"+PCounter.getReads());
	  System.out.println("Total writes after HF test1:"+PCounter.getWrites());
	  PCounter.rcounter = 0;
	  PCounter.wcounter = 0;
    if ( status == OK )
  ...
  protected boolean test2 () {
	...
	if (!done && status == OK) {
	  ...
	  System.out.println("Total reads after HF test2:"+PCounter.getReads());
	  System.out.println("Total writes after HF test2:"+PCounter.getWrites());
	  PCounter.rcounter = 0;
	  PCounter.wcounter = 0;
  ...
  protected boolean test3 () {
	...
	i += 2;     // Because we deleted the odd ones...
	  ...
	  System.out.println("Total reads after HF test3:"+PCounter.getReads());
	  System.out.println("Total writes after HF test3:"+PCounter.getWrites());
	  PCounter.rcounter = 0;
	  PCounter.wcounter = 0;
    if ( status == OK )
  ...
  protected boolean test4 () {
	...
	status = OK; 
	  ...
	  System.out.println("Total reads after HF test4:"+PCounter.getReads());
	  System.out.println("Total writes after HF test4:"+PCounter.getWrites());
	  PCounter.rcounter = 0;
	  PCounter.wcounter = 0;
