...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
    ...
    for ( pid.pid = firstPid.pid, lastPid.pid = pid.pid+numPages; status == OK && pid.pid < lastPid.pid; pid.pid = pid.pid + 1 ) {
    ...
    System.out.println("Total reads after BM test1:"+PCounter.getReads());
    System.out.println("Total writes after BM test1:"+PCounter.getWrites());
    PCounter.rcounter = 0;
    PCounter.wcounter = 0;
    if ( status == OK )
  ...
  protected boolean test2 () {
	...
	e.printStackTrace();
      ...
      System.out.println("Total reads after BM test2:"+PCounter.getReads());
      System.out.println("Total writes after BM test2:"+PCounter.getWrites());
      PCounter.rcounter = 0;
      PCounter.wcounter = 0;
    if ( status == OK )
  ...
  protected boolean test3 () {
	...
	if ( status == OK && (pid.pid % 20 == 12) ) {
      ...
      System.out.println("Total reads after BM test3:"+PCounter.getReads());
      System.out.println("Total writes after BM test3:"+PCounter.getWrites());
      PCounter.rcounter = 0;
      PCounter.wcounter = 0;
    if ( status == OK )
