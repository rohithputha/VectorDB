...
public class pnodeSplayPQ extends pnodePQ {
  ...
  */
     ...
     */
    public pnodeSplayPQ(int fldNo, AttrType fldType, TupleOrder order, Vector100Dtype target, LSHLayer layer) {
        root = null;
        count = 0;
        fld_no = fldNo;
        fld_type = fldType;
...
//    public pnodeSplayPQ(int fldNo, AttrType fldType, TupleOrder order, LSHLayer layer) {
//        root = null;
//        count = 0;
//        fld_no = fldNo;
//        fld_type = fldType;
