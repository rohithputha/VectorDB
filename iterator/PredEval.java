...
public class PredEval {
    ...
    public static boolean Eval(CondExpr p[], Tuple t1, Tuple t2, AttrType in1[],
        ...
        while (p[i] != null) {
            ...
            temp_ptr = p[i];
            while (temp_ptr != null) {
                boolean isFirstVector100D = false;
                boolean isSecondVector100D = false;
                ...
                if (isFirstVector100D && isSecondVector100D) {
                    if(comp_res > temp_ptr.vectorDistance){
                        comp_res = 1;
                    }
                    else if (comp_res < temp_ptr.vectorDistance){
                        comp_res = -1;
                    }
                    else {
                        comp_res = 0;
