...
//        LSHFIndexFile index = new LSHFIndexFile("testdb1_1_1"); // 10 hash functions, 10 layers
...
//        LSHLayerMap layerMap = LSHLayerMap.getInstance("testdb1_10_5");
...
//        }
        ...
        while(true){
            ...
            if (t != null) {
                ...
                System.out.print(v.distanceTo(createVector(100))+ " -- ");
                for (int i=0;i<100;i++){
...
//        Heapfile heapfile = new Heapfile("nn_temp.heap");
//        SystemDefs.JavabaseDB.delete_file_entry("nn_temp.heap");

        nnIndexScan.close();

        //LSHFIndexFile infile = new LSHFIndexFile("testdbv21_1_1");
    }
