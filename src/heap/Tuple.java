 ...
 throws IOException, InvalidTypeException, InvalidTupleSizeException		
{
 ...
 public int compareTupleWithTuple(int fldNo1, Tuple t2, int fldNo2, AttrType[] type)
          throws IOException, FieldNumberOutOfBoundException {
      ...
      switch (fieldType.attrType) {
          case AttrType.attrVector100D:
              Vector100Dtype v1 = Convert.get100DVectorValue(thisOffset, data);
              Vector100Dtype v2 = Convert.get100DVectorValue(otherOffset, t2.data);
  ...
  public int compareTupleWithValue(int fldNo, Object value, AttrType type)
          throws IOException, FieldNumberOutOfBoundException {
      if (fldNo <= 0 || fldNo > fldCnt) {
          throw new FieldNumberOutOfBoundException(null, "TUPLE:TUPLE_FLDNO_OUT_OF_BOUND");
      }
      ...
      switch (type.attrType) {
          case AttrType.attrVector100D:
              Vector100Dtype v1 = Convert.get100DVectorValue(offset, data);
