...
public class TestDriver {
  ...
  protected boolean runAllTests() {
    ...
    System.out.println("Total reads after test1:"+PCounter.getReads());
    System.out.println("Total writes after test1:"+PCounter.getWrites());
    if (!test2()) { _passAll = FAIL; }
    System.out.println("Total reads after test2:"+PCounter.getReads());
    System.out.println("Total writes after test2:"+PCounter.getWrites());
    if (!test3()) { _passAll = FAIL; }
    System.out.println("Total reads after test3:"+PCounter.getReads());
    System.out.println("Total writes after test3:"+PCounter.getWrites());
    if (!test4()) { _passAll = FAIL; }
    System.out.println("Total reads after test4:"+PCounter.getReads());
    System.out.println("Total writes after test4:"+PCounter.getWrites());
    if (!test5()) { _passAll = FAIL; }
    System.out.println("Total reads after test5:"+PCounter.getReads());
    System.out.println("Total writes after test5:"+PCounter.getWrites());
    if (!test6()) { _passAll = FAIL; }
    System.out.println("Total reads after test6:"+PCounter.getReads());
    System.out.println("Total writes after test6:"+PCounter.getWrites());
