...
class DBDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
	...
	e.printStackTrace();
      ...
      System.out.println("Total reads after DB test1:"+PCounter.getReads());
      System.out.println("Total writes after DB test1:"+PCounter.getWrites());
      PCounter.rcounter = 0;
      PCounter.wcounter = 0;
    if ( status == OK )
  ...
  protected boolean test2 () {
	...
	if (readStr.equals(testStr) != true) {
      ...
      System.out.println("Total reads after DB test2:"+PCounter.getReads());
      System.out.println("Total writes after DB test2:"+PCounter.getWrites());
      PCounter.rcounter = 0;
      PCounter.wcounter = 0;
  ...
  protected boolean test3 () {
	...
	status = OK;
      ...
      System.out.println("Total reads after DB test3:"+PCounter.getReads());
      System.out.println("Total writes after DB test3:"+PCounter.getWrites());
      PCounter.rcounter = 0;
      PCounter.wcounter = 0;
  ...
  protected boolean test4 ()  {
	...
	status = FAIL;
      ...
      System.out.println("Total reads after DB test4:"+PCounter.getReads());
      System.out.println("Total writes after DB test4:"+PCounter.getWrites());
      PCounter.rcounter = 0;
      PCounter.wcounter = 0;
    if ( status == OK ) {
