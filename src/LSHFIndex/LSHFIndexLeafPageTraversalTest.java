...
public class LSHFIndexLeafPageTraversalTest {
    public static void main(String[] args) {
        try {
            ...
            SystemDefs sysdef = new SystemDefs(dbpath, numPages,4096, "Clock");
...
//            LSHFIndexFile index = new LSHFIndexFile("testIndex", 5, 10); // 10 hash functions, 10 layers
            ...
            LSHFIndexFile index = new LSHFIndexFile("testdb1_10_5", 5, 5);
...
//            LSHLayerMap layerMap = LSHLayerMap.getInstance("testIndex");
...
//
//            Sort sort = index.nearestNeighbourScan(createVector(1), 5);
//            Tuple result;
//            int count = 0;
...
//            }
//
//            LSHFLeafPage leafPage = new LSHFLeafPage("testIndex");
//            for (int i=0;i<300;i++){
//                System.out.println("Inserting " + i + " page");
//                leafPage.insert(createVector(1),new RID(new PageId(i), 1));
//            }
    ...
    public static void analyzepage(PageId pid) throws Exception{
        LSHBasePage page = new LSHBasePage(pid, "testIndex");
        page.dumpPage();
