...
public class Sort extends Iterator implements GlobalConst {
	...
	*/
    ...
    private int generate_runs(int max_elems, AttrType sortFldType, int sortFldLen)
        ...
        Tuple tuple;
        pnode cur_node;
        pnodeSplayPQ Q1 = new pnodeSplayPQ(_sort_fld, sortFldType, order, this.target, null);
        pnodeSplayPQ Q2 = new pnodeSplayPQ(_sort_fld, sortFldType, order, this.target, null);
	...
	*/
    ...
    public Sort(AttrType[] in,
        ...
        max_elems_in_heap = 100000;
        sortFldLen = sort_fld_len;

        Q = new pnodeSplayPQ(sort_fld, _in[sort_fld - 1], order, target, null);
        // Task 4
        ...
        if (_in[_sort_fld - 1].attrType == AttrType.attrVector100D && target != null) {
            ...
            if (output_tuple != null) {
                ...
                if (k > 0) {
                    processed++;
                    if (processed > k) {
                        Q = new pnodeSplayPQ(_sort_fld, _in[_sort_fld - 1], order, this.target, null);
                        return null;
                    }
                }
                return op_buf;
