...
public class Convert{
  ...
  public static Vector100Dtype getVector100DValue(int position, byte[] data) throws IOException {
      InputStream in;
      ...
      value = new Vector100Dtype(values);
      return value;
  }
 ...
 */
  ...
  public static char getCharValue (int position, byte []data)
    ...
    public static void setVector100DValue(Vector100Dtype vectorValue, int position, byte[] data) throws IOException {
        ...
        for(int i=0;i<100;i++){
            outstr.writeShort(vectorValue.get(i));
        }
